page 50060 "Banquet Event Order List"
{
    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'Banquet Order List';
    CardPageID = "Banquet Event Order";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Order), "Status of event" = filter('Definite'));
    UsageCategory = Lists;
