page 50095 "Cust. Cash Receipt - Journal"
{
    AutoSplitKey = true;
                ...
                group(SendApprovalRequest)
                {
                    ...
                    action(SendApprovalRequestJournalBatch)
                    {
                        ...
                        begin
                            ...
                            if not GenjouLineL.IsEmpty() then
                                Preview := false;
                            if Preview then
    ...
    local procedure LookupCustumisedBatchName(var CurrentJnlBatchName: code[20]; VAR GenJnlLine: Record "Gen. Journal Line")
    var
