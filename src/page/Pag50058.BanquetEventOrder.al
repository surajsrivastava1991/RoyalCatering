page 50058 "Banquet Event Order"
{
            ...
            group(General)
            {
                ...
                field("Type of Sale"; "Type of Sale")
                {
                    ...
                    begin
                        ...
                        if not ("Type of Sale" in ["Type of Sale"::" ", "Type of Sale"::Contract, "Type of Sale"::"Counter Sale"]) then
                            Error('Select Contract or Counter Sale.');
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            group("P&osting")
            {
                ...
                action("Banquet Event Report")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Banquest Event Report';
                    Ellipsis = true;
                    Promoted = true;
                    PromotedOnly = true;
    ...
    begin
        ...
        //Suraj
        if "Type of Sale" in ["Type of Sale"::Contract, "Type of Sale"::"Counter Sale", "Type of Sale"::" "] then
    ...
    begin
        ...
        "Type of Sale" := "Type of Sale"::" ";//Aplica.1.0
        //Suraj
        if "Type of Sale" in ["Type of Sale"::Contract, "Type of Sale"::"Counter Sale", "Type of Sale"::" "] then
            "Status of event" := "Status of event"::Definite;
